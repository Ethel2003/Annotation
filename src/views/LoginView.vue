...
<template>
    <div class="h-screen w-screen flex justify-center items-center">
        ...
        <div class="form-container z-1">
            <div class="heading text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-fuchsia-500 to-blue-400
  drop-shadow-[0_0_10px_rgba(255,255,255,0.8)] animate-pulse">Phonéos</div>
...
.form-container {
    max-width: 350px;
    background: #f8f9fd;
    background: linear-gradient(#212121, #272749) padding-box,
